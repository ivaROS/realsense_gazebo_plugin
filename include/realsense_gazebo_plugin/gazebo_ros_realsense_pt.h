#ifndef _GAZEBO_ROS_REALSENSE_PLUGIN_PT_
#define _GAZEBO_ROS_REALSENSE_PLUGIN_PT_
...
class GazeboRosRealsensePt : public RealSensePluginPt {
  /// \brief Constructor.
public:
  GazeboRosRealsensePt();
...
#endif /* _GAZEBO_ROS_REALSENSE_PLUGIN_PT_ */
